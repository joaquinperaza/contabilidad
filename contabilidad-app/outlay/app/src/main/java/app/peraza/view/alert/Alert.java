...
public final class Alert {
    ...
    public static void info(View view, String message, View.OnClickListener clickListener, Snackbar.Callback callback) {
        ...
        if (clickListener != null) {
            bar.setAction(context.getString(app.peraza.R.string.label_undo), clickListener);
            bar.setActionTextColor(ContextCompat.getColor(context, app.peraza.R.color.red));
        }
        if(callback != null) {

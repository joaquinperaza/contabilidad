...
import app.peraza.view.adapter.listener.OnCategoryClickListener;
import app.peraza.view.numpad.NumpadEditable;
import app.peraza.view.numpad.NumpadValidator;
import app.peraza.view.numpad.NumpadView;
...
public class CategoriesGridAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        switch (viewType) {
            case HEADER:
                final View numpadView = inflater.inflate(app.peraza.R.layout.recycler_numpad, parent, false);
                GridLayoutManager.LayoutParams params = (GridLayoutManager.LayoutParams) numpadView.getLayoutParams();
                params.height = parent.getMeasuredHeight() - (context.getResources().getDimensionPixelSize(app.peraza.R.dimen.category_item_height) * 2);

                final NumpadViewHolder viewHolder = new NumpadViewHolder(numpadView);
                return viewHolder;
            default:
                final View catView = inflater.inflate(app.peraza.R.layout.item_category, parent, false);
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        if (holder instanceof CategoryViewHolder) {
            ...
            Drawable categoryIcon = IconUtils.getCategoryIcon(context, iconCodeRes, currentOne.getColor(), app.peraza.R.dimen.category_icon);
    ...
    public class CategoryViewHolder extends RecyclerView.ViewHolder {
        @Bind(app.peraza.R.id.categoryContainer)
    ...
    public class NumpadViewHolder extends RecyclerView.ViewHolder {
        @Bind(app.peraza.R.id.numpadView)

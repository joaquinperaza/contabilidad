...
import app.peraza.view.progress.ProgressLayout;
...
public class ReportAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        if (viewType == TYPE_CHART) {
            final View v = inflater.inflate(app.peraza.R.layout.layout_chart, parent, false);
            result = new ChartViewHolder(v);

        } else {
            final View v = inflater.inflate(app.peraza.R.layout.item_report, parent, false);
    ...
    public class ReportViewHolder extends RecyclerView.ViewHolder {
        ...
        PrintView icon;
        @Bind(app.peraza.R.id.reportContainer)
    ...
    public class ChartViewHolder extends RecyclerView.ViewHolder {
        @Bind(app.peraza.R.id.chart)
        PieChart chart;

        @Bind(app.peraza.R.id.hideLabels)
        ImageView hideLabels;

        @Bind(app.peraza.R.id.previous)
        ImageView prev;

        @Bind(app.peraza.R.id.next)
        ImageView next;

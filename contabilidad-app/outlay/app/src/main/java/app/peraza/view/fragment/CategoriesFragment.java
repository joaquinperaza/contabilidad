...
import app.peraza.view.adapter.CategoriesDraggableGridAdapter;
import app.peraza.domain.model.Category;
import app.peraza.mvp.presenter.CategoriesPresenter;
...
import app.peraza.view.helper.itemtouch.OnDragListener;
import app.peraza.view.helper.itemtouch.SimpleItemTouchHelperCallback;
...
public class CategoriesFragment extends BaseMvpFragment<CategoriesView, CategoriesPresenter> implements OnDragListener, CategoriesView {
    ...
    @Bind(app.peraza.R.id.noContent)
    View noContent;

    @Bind(app.peraza.R.id.noContentImage)
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View view = inflater.inflate(app.peraza.R.layout.fragment_categories, null, false);
        return view;
    }
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        getActivity().setTitle(getString(app.peraza.R.string.caption_categories));
        ...
        Drawable noCategoryIcon = IconUtils.getIconMaterialIcon(
                ...
                app.peraza.R.dimen.icon_no_results,
                16
        );

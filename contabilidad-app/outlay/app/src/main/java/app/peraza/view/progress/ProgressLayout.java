package app.peraza.view.progress;
...
public class ProgressLayout extends View implements Animatable {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, app.peraza.R.styleable.progressLayout);
        isAutoProgress = a.getBoolean(app.peraza.R.styleable.progressLayout_autoProgress, true);
        maxProgress = a.getInt(app.peraza.R.styleable.progressLayout_maxProgress, 0);
        maxProgress = maxProgress * 10;
        int loadedColor = a.getColor(app.peraza.R.styleable.progressLayout_loadedColor, COLOR_LOADED_DEFAULT);
        int emptyColor = a.getColor(app.peraza.R.styleable.progressLayout_emptyColor, COLOR_EMPTY_DEFAULT);
        a.recycle();

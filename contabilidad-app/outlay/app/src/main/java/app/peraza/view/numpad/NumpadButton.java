...
public class NumpadButton extends RelativeLayout {
    ...
    @Nullable
    @Bind(app.peraza.R.id.textValue)
    TextView textValue;

    @Nullable
    @Bind(app.peraza.R.id.numpadIcon)
    ...
    private void init(AttributeSet attrs) {
        ...
        TypedArray ta = getContext().obtainStyledAttributes(attrs, app.peraza.R.styleable.NumpadButton, 0, 0);
        try {
            String icon = ta.getString(app.peraza.R.styleable.NumpadButton_numpadButtonIcon);
            String name = ta.getString(app.peraza.R.styleable.NumpadButton_numpadButtonText);
    ...
    private View initTextButton(LayoutInflater inflater) {
        View parent = inflater.inflate(app.peraza.R.layout.view_numpad_button, this, true);
        ButterKnife.bind(this, parent);
        return parent;
    }

    private View initIconButton(LayoutInflater inflater) {
        View parent = inflater.inflate(app.peraza.R.layout.view_numpad_icon_button, this, true);
        ButterKnife.bind(this, parent);
        return parent;
    }
}
